...
class MoneyTransferPageTest {
    ...
    void shouldTransferMoneyBetweenOwnCards() {
        ...
        ((DashboardPage) dashboard).moneyTransfer(cardNumber(1)).transaction(Integer.toString(value1), cardNumber(2));
        ((DashboardPage) dashboard).moneyTransfer(cardNumber(1)).transaction(Integer.toString(value2), cardNumber(2));
        ((DashboardPage) dashboard).moneyTransfer(cardNumber(2)).transaction(Integer.toString(value3), cardNumber(1));
        cardsBalance = cardsBalance();
