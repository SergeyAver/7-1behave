...
public class DashboardPage {
    ...
    public static int[] cardsBalance() {
        ...
        String tmp = $$(".list__item").find(text(cardNumber(1).substring(15, 19))).$("div").getText().substring(20);
        result[1] = Integer.parseInt(CharMatcher.inRange('0', '9').retainFrom(tmp));
        String tmp2 = $$(".list__item").find(text(cardNumber(2).substring(15, 19))).$("div").getText().substring(20);
